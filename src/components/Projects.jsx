        ...
        <section id="Projects" className="bg-black text-white py-24 px-6 md:px-12 lg:px-20">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 mb-20">
                    ...
                    <p className="text-gray-400 inter-md max-w-md leading-relaxed">
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center gap-8 lg:w-1/4">
                                    ...
                                    <h3 className="text-sm uppercase tracking-[0.2em] text-gray-500 inter-small group-hover:text-white transition-colors">
                                        {item.category}
                                    </h3>
                                </div>

                                <div className="lg:w-2/4">
                                    <h4 className="text-3xl md:text-5xl inter-bold mb-4 group-hover:translate-x-4 transition-transform duration-500 ease-out">
                                        {item.title}
                                    </h4>
                                    <p className="text-gray-500 inter-small group-hover:text-gray-300 max-w-lg transition-colors duration-500">
                                        {item.description}
                                    </p>
                                </div>
