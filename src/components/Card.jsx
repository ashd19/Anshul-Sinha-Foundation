    ...
    >
      ...
      <div className="relative h-full w-full p-8 flex flex-col justify-between z-10">
        ...
        <div className="flex items-start">
          <motion.span className="text-8xl inter-bold text-white tracking-tighter">
            {rounded}
          </motion.span>
          <Plus
            className="mt-4  text-[#f2ac83]"
            strokeWidth={3}
            size={48}
          />
        </div>
        ...
        <div className="space-y-3">
          <h2 className="text-3xl inter-bold text-white leading-tight">
            {heading}
          </h2>
          <p className="text-gray-200 text-lg inter-md opacity-90 leading-relaxed">
            {text}
          </p>
        </div>
      </div>
