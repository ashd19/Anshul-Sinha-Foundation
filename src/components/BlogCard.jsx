                        ...
                        <div className="flex flex-col justify-between">
                            <div>
                                <div className="flex gap-2 mt-7  items-center justify-start mb-1">
                                    <div className="rounded-full w-fit px-3 py-1 h-[25px] bg-[#f3ad84] inter-md text-[#1d332c] text-[0.7rem] uppercase">{tag}</div>
                                    <div className="w-[6px]  h-[5px] bg-black rounded-full ">
                                    </div>
                                    <div className="inter-small text-[0.8rem] tracking-tight whitespace-nowrap text-[#1d332c]">{date}</div>
                                    <div className="w-[6px]  h-[5px] bg-black rounded-full ">
                                    </div>
                                    <div className="inter-small text-[0.8rem] tracking-tight whitespace-nowrap text-[#1d332c] uppercase">{timeToRead} min read</div>
                                </div>
                                <div>
                                    <h1 className="inter-bold text-[1.4rem] tracking-tight md:whitespace-nowrap whitespace-normal leading-7 text-[#1d332c]">{heading}</h1>
                                </div>
                            </div>
                            <div className="flex rounded-full items-center bg-[#f6f7e9] px-3 py-2 w-[100px] h-[25px]">
                                <h1 className="text-[#1d332c] text-[0.7rem] inter-small whitespace-nowrap">Read Post</h1>
