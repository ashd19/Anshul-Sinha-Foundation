...
function AboutUs() {
  return (
    <div>
      <div
      id="About"
      className=" min-h-screen py-16 px-6 sm:px-12 md:px-20 lg:px-32 flex items-center">
      ...
      <div className="cards flex md:w-full md:px-20  md:flex-row  flex-col md:gap-3 gap-7 mt-5 mb-25">
        <Card
          number={1000}
        ...
        <Card
          ...
          text={
            "Families restore  safety and dignity."
          }
        />
        <Card
          number={256}
          ...
          text={
            "Supporting in healthcare and crisis."
          }
        />
      </div>
    </div>
