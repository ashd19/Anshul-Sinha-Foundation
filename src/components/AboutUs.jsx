...
function AboutUs() {
  return (
    <div className="bg-[#f1f1f3] h-screen p-10">
      <div className="flex gap-10 ">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex w-fit px-4 py-3 md:px-5 md:py-3 rounded-3xl text-black bg-white transition-colors duration-200 ease-in hover:text-white hover:bg-black gap-2 items-center cursor-pointer  transition-colors">
